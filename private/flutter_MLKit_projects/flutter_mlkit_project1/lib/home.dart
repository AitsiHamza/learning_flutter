...
class _HomeState extends State<Home> {
    ...
    await cameraController!.initialize().then((value) {
      ...
      cameraController!.startImageStream((imageFromStream) => {
            if (!isWorking)
              {
                isWorking = true,
                performDetectionOnStremFrames(imageFromStream),
              }
          });
    });
  }
  ...
  performDetectionOnStremFrames(CameraImage cameraImage) async {
    UtilsScanner.detect(
      image: cameraImage,
  ...
  Widget buildResult() {
    ...
    CustomPainter customPainter =
        FaceDettectorPainter(imageSize, scanResults, cameraLensDirection);
...
class FaceDettectorPainter extends CustomPainter {
  FaceDettectorPainter(
  ...
  @override
  bool shouldRepaint(FaceDettectorPainter oldDelegate) {
